...
public class MyFrame extends JFrame implements ActionListener {
    ...
    MyFrame() {
        ...
        topPanel.setBackground(Color.lightGray); // Sets color for JPanel
        topPanel.setVisible(true); // Sets whether or not JPanel is visible

        centerPanel = new JPanel(); // Creates a new instance of JPanel
        centerPanel.setBackground(Color.black); // Sets color for JPanel
